...
//import org.firstinspires.ftc.teamcode.autons.AUTON2025REDLEFT;
//
...
//      @Override
//      public boolean run (@NonNull TelemetryPacket packet){
//        if (!initialized && gamepad1.dpad_up) {
//          arm1.setTargetPosition(arm1.getCurrentPosition()+500);
//          arm1.setPower(0.8);
//        }
//        else if (!initialized && gamepad1.dpad_down) {
//          arm1.setTargetPosition(arm1.getCurrentPosition()-500);
//          arm1.setPower(-0.8);
//        }
...
//        }
//      }
//    public Action liftControl() { return new liftControl();}
//  }
//  public class ARM2 {
